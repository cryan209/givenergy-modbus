...
class GivEnergyClient:
    ...
    def set_export_limit_wattage(self, val: int):
        """Set Grid export limit for inverter."""
        self.modbus_client.write_holding_register(HoldingRegister.GRID_PORT_MAX_POWER_OUTPUT, val)

    def enable_over_6kw_system(self):
        """Enable over 6KW system value"""
        self.modbus_client.write_holding_register(HoldingRegister.ENABLE_ABOVE_6KW_SYSTEM, True)
    
    def disable_over_6kw_system(self):
        """Disable over 6KW system value"""
        self.modbus_client.write_holding_register(HoldingRegister.ENABLE_ABOVE_6KW_SYSTEM, False)

    def get_system_data(self):
        """Get useful System (Inverter and Battery) data"""
